        ...
        <div className=" xl:p-0 sm:p-8 p-6 w-full xl:w-1/2 ">
               ...
               <div className=" p-4 sm:p-2 xl:p-6 w-full xl:w-1/2 h-full  text-2xl sm:flex  sm:justify-center ">
                   <div className="w-full sm:w-3/4">
                       ...
                       <div className="">
                          <button onClick={(e)=>{setValue(1)}} className="  h-10 p-1 sm:h-14 sm:p-2  rounded border-2 border-green-300  hover:bg-white hover:text-green-300  bg-green-300 text-white">Learn courses</button>
                         </div>
